...
const uint8_t gtFont[] = {
  ...
  0x14,0x3E,0x14,0x3E,0x14,0x00,0x00,0x00, // 3  = #
  ...
  0x3E,0x41,0x41,0x41,0x41,0x00,0x00,0x00, // 67 = c
  0x7F,0x41,0x41,0x41,0x3E,0x00,0x00,0x00, // 68 = d
  0x7F,0x49,0x49,0x41,0x41,0x00,0x00,0x00, // 69 = e
  0x7F,0x09,0x09,0x01,0x01,0x00,0x00,0x00, // 70 = f
  0x3E,0x41,0x41,0x49,0x38,0x00,0x00,0x00, // 71 = g
  ...
  0x00,0x3E,0x3E,0x3E,0x3E,0x3E,0x00,0x00, // 96 QuadMark       0x80
  0x3C,0x42,0x81,0x81,0x81,0x81,0x42,0x3C, // 97 Circle         0x81
  0x3C,0x42,0x99,0xBD,0xBD,0x99,0x42,0x3C, // 98 Filled Circle  0x82
  0x3C,0x7E,0xFF,0xFF,0xFF,0xFF,0x7E,0x3C, // 99 fFilled Circle 0x83
  0x08,0x10,0x08,0x10,0x08,0x10,0x08,0x10, // 100 Taxi          0x84

  0xDB,0xDB,0xDB,0xDB,0xDB,0xDB,0xDB,0xDB, // 100  0x85
  0x66,0x66,0x66,0x66,0x66,0x66,0x66,0x66, // 101  0x86
  0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18, // 102  0x87
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, // 103  0x88 
  0x00,0x00,0x00,0xFF,0xFF,0x00,0x00,0x00, // 104  0x89
  0x00,0xFF,0xFF,0x00,0x00,0xFF,0xFF,0x00, // 105  0x8A
  0xFF,0xFF,0x00,0xFF,0xFF,0x00,0xFF,0xFF, // 106  0x8B

  0x3C,0x4E,0x8F,0x8F,0x8F,0x8F,0x4E,0x3C, // NORTH 0x8C
  0x3C,0x42,0x81,0x81,0xFF,0xFF,0x7E,0x3C, // EAST  0x8D
  0x3C,0x72,0xF1,0xF1,0xF1,0xF1,0x72,0x3C, // SOUTH 0x8E
  0x3C,0x7E,0xFF,0xFF,0x81,0x81,0x42,0x3C, // WEST  0x8F

  // Narrow numbers ////////////////////////////////////
  0x3E,0x41,0x41,0x41,0x3E,0x00,0x00,0x00, // 0     0x90
  0x42,0x42,0x7F,0x40,0x40,0x00,0x00,0x00, // 1     0x91
  0x71,0x49,0x49,0x49,0x46,0x00,0x00,0x00, // 2     0x92
  0x41,0x41,0x49,0x49,0x36,0x00,0x00,0x00, // 3     0x93
  0x18,0x14,0x12,0x11,0x7F,0x00,0x00,0x00, // 4     0x94
  0x4F,0x49,0x49,0x49,0x30,0x00,0x00,0x00, // 5     0x95
  0x3E,0x49,0x49,0x49,0x30,0x00,0x00,0x00, // 6     0x96
  0x01,0x71,0x09,0x05,0x03,0x00,0x00,0x00, // 7     0x97
  0x36,0x49,0x49,0x49,0x36,0x00,0x00,0x00, // 8     0x98
  0x06,0x49,0x49,0x49,0x3E,0x00,0x00,0x00, // 9     0x99
  // Sieve/Permutation glyphs //////////////////////////////////
  0x3C,0x42,0x81,0x81,0x81,0x81,0x42,0x3C, // SIEVE USEL    0x9A
  0x3C,0x42,0x89,0x8D,0x8D,0x89,0x42,0x3C, // SIEVE  SEL    0x9B
  0x3C,0x42,0x81,0x81,0x81,0x81,0x42,0x3C, // PERMUTE USEL  0x9C
  0x3C,0x42,0x81,0x81,0xBD,0x99,0x42,0x3C, // PERMUTE  SEL  0x9D
  
  0x3E,0x7F,0x41,0x75,0x75,0x71,0x7F,0x3E, // PERMUTE pSEL  0x9E
  0x00,0x00,0x3E,0x0A,0x0A,0x0E,0x00,0x00, // PERMUTE pUSEL 0x9F
  0x3E,0x7F,0x51,0x55,0x55,0x45,0x7F,0x3E, // SIEVE S SEL 	0xA0
  0x00,0x00,0x2E,0x2A,0x2A,0x3A,0x00,0x00, // SIEVE S USEL  0xA1

  0x3E,0x7F,0x41,0x75,0x75,0x41,0x7F,0x3E, // AUTO SEL 		0xA2
  0x00,0x00,0x3E,0x0A,0x0A,0x3E,0x00,0x00  // AUTO USEL 	0xA3
};
